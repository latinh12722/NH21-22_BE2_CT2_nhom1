...
<div class="">
  ...
  <section class="content">
    <form action="{{url('admin/manufactures/edit-manufacture')}}" method="post">
      @csrf
      <div class="row">
        <div class="col-md">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input value="{{ $manufacture->manu_id }}" disabled type="text" id="inputName" class="form-control">
                <input type="hidden" name="manu_id" value="{{ $manufacture->manu_id }}">
              </div>
              <div class="form-group">
                <label for="inputName">Manufacture Name</label>
                <input name="manu_name" type="text" value="{{ $manufacture->manu_name }}" id="inputName" class="form-control">
              </div>
