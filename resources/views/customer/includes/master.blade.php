        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    <li class="{{(new \App\Helpers\Helper)->return_active_navbar_manu(-1, url()->current())}}"><a href="{{url('')}}">Home</a></li>
                    <!-- active -->

                    @foreach((new \App\Helpers\Helper)->getAllManu() as $value)

                    <li class="{{(new \App\Helpers\Helper)->return_active_navbar_manu($value->manu_id, url()->current())}}"><a href="{{url('store/manu/'.$value->manu_id)}}">{{$value->manu_name}}</a></li>
                    @endforeach
                </ul>
                <!-- /NAV -->
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="footer">
                            ...
                            <ul class="footer-links">
                                @foreach((new \App\Helpers\Helper)->getAllProtypes() as $value)
                                <li><a href="{{url('store/type/'.$value->type_id)}}">{{$value->type_name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
